...
class CommandTests(SimpleTestCase): 
    ...
    def test_wait_for_db_readiness(self, patched_check):
        ...
        # Simulate calling the command "wait_for_db" located in the commands folder in command line
    ...
    def test_wait_for_db_delay(self, patched_sleep, patched_check):
        ...
        # Raise expectional error in the order they are called in when starting postgresql
